...
<template>
  <div class="container mx-auto px-4 py-8 max-w-5xl">
    ...
    <p class="text-base-content/90 mb-8">Select two countries to compare their key statistics side by side</p>
    ...
    <div v-if="country1 && country2" class="grid grid-cols-[1fr_auto_1fr] gap-4 mb-6" aria-live="polite">
      <div class="text-center">
        ...
        <p class="text-sm text-base-content/90">{{ country1.continent }}</p>
      </div>

      <div class="flex items-center justify-center text-2xl font-bold text-base-content/60" aria-hidden="true">
        VS
      </div>
      ...
      <div class="text-center">
        ...
        <p class="text-sm text-base-content/90">{{ country2.continent }}</p>
      </div>
    </div>
    ...
    <div v-if="country1 && country2" class="space-y-6" role="region" aria-label="Metric comparisons">
      ...
      >
        <div class="text-sm font-medium mb-2 text-center" :id="`metric-${metric.key}`">
          {{ metric.label }}
        </div>
        ...
        <div class="grid grid-cols-[1fr_auto_1fr] gap-2 items-center">
          ...
          <!-- Ratio -->
          <div class="w-16 text-center text-xs" aria-hidden="true">
            {{ metric.unit }}
          </div>
